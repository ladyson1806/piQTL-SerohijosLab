...
def display_density_plot(all_A_vs_B, MTX, SINGLE):
    ...
    if not os.path.exists(f"../../figures/figure_1"):
        os.makedirs(f"../../figures/figure_1")
...
if __name__ == "__main__":
    lineage_tracking_stats = pd.read_csv("../../results/02_lineage_tracking/lineage_tracking_stats.csv")
    ...
    #### FIGURE PANEL F
    log_folder = f"../../results/01_barcode_count/log"
    logs = [
