...
if __name__ == "__main__":
    ...
    base_folder = '/home/savvy/PROJECTS/PHD/DATA/piQTL/DATA' #### Folder where are the final dataset with the concatanated fastq.gz are

    print('piQTL pipeline - Barcode extraction')

    ### 1. Demultiplexing + inner barcode trimming
    original_folder = os.path.join(base_folder,'original') #'/home/savvy/PROJECTS/PHD/DATA/piQTL/DATA/original/'
    ...
    for folder in sorted(os.listdir(original_folder)): 
        ...
        demultiplex_folder = os.path.join(base_folder,'demultiplexed') #'/home/savvy/PROJECTS/PHD/DATA/piQTL/DATA/demultiplexed/'
        ...
        merged_folder = os.path.join(base_folder,'merged') #'/home/savvy/PROJECTS/PHD/DATA/piQTL/DATA/merged/'
