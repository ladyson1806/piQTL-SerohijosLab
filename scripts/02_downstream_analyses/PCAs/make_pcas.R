...
# setEPS()
# postscript(file = "../../../figures/supp_figure_3/minus_ref_logratio_Fitness_tnsne.eps", width = 7.1, height = 3.5, family = "Helvetica", pointsize=7)  # ToDo: modify output path
...
# setEPS()
# postscript(file = "../../../figures/supp_figure_3/minus_ref_logratio_Fitness_PCs_per_PPI.eps", width = 12, height = 6, family = "Helvetica", pointsize=12)  # ToDo: modify output path
# # print the result (in this case a ggplot)
...
pdf(file = "../../../figures/supp_figure_3/minus_ref_logratio_Fitness_PCs_per_Drug.pdf", width = 6, height = 2, family = "Helvetica", pointsize=5)  # ToDo: modify output path
# print the result (in this case a ggplot)
...
pdf(file = "../../../figures/supp_figure_3/minus_ref_logratio_Fitness_PCs_per_MTX.pdf", width = 6, height = 2, family = "Helvetica", pointsize=5)  # ToDo: modify output path
