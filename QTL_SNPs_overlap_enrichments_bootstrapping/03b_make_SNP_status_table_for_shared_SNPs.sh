...
mkdir -p out/overlap_status_shared_snps
...
OVERLAP_STATUS_TABLE="out/overlap_status_shared_snps/piQTL_overlap_status.csv"
...
OVERLAP_STATUS_TABLE_NO_FILTERING="out/overlap_status_shared_snps/piQTL_overlap_status_no_filtering.csv"
